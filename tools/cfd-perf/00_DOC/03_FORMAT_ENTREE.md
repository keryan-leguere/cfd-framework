...
Exemple complet et commenté : [`01_EXEMPLE/ONERA_M6_CRUISE.yaml`](../src/cfd_perf/01_EXEMPLE/ONERA_M6_CRUISE.yaml), que `cfd-perf example`
déplie dans un répertoire de travail.
