...
cfd-atm renders its figures with ``cfd_plot`` when that package is installed,
and falls back to plain Matplotlib when it is not: cfd-atm must stay usable
...
cannot be declared as a normal dependency. Install it alongside cfd-atm with::
